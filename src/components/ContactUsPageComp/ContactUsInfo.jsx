...
const ContactUsInfo = () => {
  return (
    <div className='px-6 pt-15 pb-3'>
      <h2 className='text-[25px] font-extrabold text-gray-900 mb-8 xl:ml-80 l:ml-150 md:ml-4 '>Contact Details</h2>
      ...
      <div className='flex flex-col lg:flex-row justify-center gap-6'>
        ...
        <div className='flex flex-col gap-4 w-full lg:w-auto'>
          ...
          <div >
            ...
            >
            <div className='flex flex-col'>
              <h2 className='font-bold text-[16px] mb-2'>info@skillsdynamix.com</h2>
